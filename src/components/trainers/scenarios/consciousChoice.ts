  ...
  steps: [
    {
      ...
      description:
        "Этот тренажёр поможет вам разобраться в текущей ситуации выбора. Вы исследуете свои ценности, страхи и интуицию — и подойдёте к решению осознанно, а не на автопилоте. Отвечайте честно — здесь нет правильных и неправильных ответов.",
    },
    {
      id: "cc-decision",
      type: "text-input",
