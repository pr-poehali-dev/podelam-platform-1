...
export const TRAINER_DEFS: TrainerDef[] = [
  ...
  },
  {
    ...
    subtitle: "Ежедневная практика · 5-7 мин",
    description:
      "Фиксируйте достижения, отслеживайте реакции на трудности и формируйте опору на факты, а не на эмоции. Индекс IVO покажет рост вашей внутренней устойчивости.",
    color: "bg-emerald-50",
    ...
    accessPlans: [
      ...
      },
      {
        ...
        price: 6990,
        features: [
          "Годовая динамика IVO",
          "Анализ паттернов реакций",
          "Глубокая аналитика",
        ],
      },
    ],
    stepsCount: 9,
    estimatedMinutes: 6,
    tags: ["самооценка", "опора", "IVO", "ежедневно"],
  },
  {
    id: "money-anxiety",
    icon: "Wallet",
    title: "Деньги без тревоги",
    subtitle: "Психология денег · FSI",
    description:
      "Не про учёт доходов — про психологию денег. Выявите денежные триггеры, обнаружьте ограничивающие установки, переведите тревогу в конкретное финансовое действие. Индекс FSI покажет рост вашей финансовой устойчивости.",
    color: "bg-sky-50",
    ...
    accessPlans: [
      {
        ...
        label: "1 месяц",
        price: 990,
        features: ["Работа с денежной тревогой", "До 4 сессий"],
      },
      {
        duration: "3months",
        label: "3 месяца",
      ...
      },
      {
        ...
        price: 6990,
        features: [
          "Годовая динамика FSI",
          "Анализ денежных импульсов",
          "Глубокая проработка",
        ],
      },
    ],
    stepsCount: 12,
    estimatedMinutes: 8,
    tags: ["деньги", "тревога", "FSI", "финансы"],
  },
];
