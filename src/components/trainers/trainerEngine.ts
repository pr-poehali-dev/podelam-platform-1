...
function calculateConsciousChoiceResult(
  ...
  if (total >= 25) {
    ...
    summary =
      "Вам свойственно сомневаться в решениях. Это нормально — каждый проход тренажера укрепляет навык.";
  }
  ...
  recommendations.push(
    "Повторите тренажер через неделю, чтобы отследить динамику."
  );
  ...
  return {
    ...
    nextActions: [
      ...
      "Вернуться к тренажеру через 7 дней",
    ],
  };
}
...
function calculateEmotionsResult(
  ...
  if (EMI >= 86) {
    ...
    summary =
      "Эмоции часто управляют вашими реакциями. Регулярная работа с тренажером поможет увидеть закономерности.";
  } else {
    level = "beginning";
    title = "Эмоции управляют";
    summary =
      "Сейчас эмоции сильно влияют на ваши решения. Каждое прохождение тренажера — шаг к осознанности.";
  }
  ...
  recommendations.push(
    "Повторяйте тренажер регулярно — система покажет ваши эмоциональные паттерны."
  );
  ...
  return {
    ...
    insights,
    nextActions: [
      "Выполнить план действия из тренажера",
...
function calculateAntiProcrastinationResult(
  ...
  recommendations.push("Повторяйте тренажер ежедневно — 3 дня подряд сформируют «Запуск», 21 день — привычку.");
...
function calculateSelfEsteemResult(
  ...
  if (IVO >= 86) {
    ...
    summary = "Внешнее мнение ещё сильно влияет. Каждый день с тренажером — шаг к устойчивости.";
  } else {
    level = "beginning";
    title = "Низкая опора";
  ...
  recommendations.push("Проходите тренажер ежедневно — динамика IVO покажет рост вашей внутренней опоры.");
...
function calculateMoneyAnxietyResult(
  ...
  if (FSI >= 86) {
    ...
    summary = "Денежная тревога часто влияет на решения. Регулярная работа с тренажером покажет паттерны.";
  } else {
    level = "beginning";
  ...
  recommendations.push("Повторяйте тренажер регулярно — система покажет ваши денежные паттерны и рост FSI.");
  ...
  return {
    ...
    insights,
    nextActions: [
      "Выполнить финансовый шаг из тренажера в течение 48 часов",
      "Повторить тренажер через 3–5 дней для отслеживания динамики",
    ],
  };
}
