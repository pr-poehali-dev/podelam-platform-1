...
// ─── ОПИСАНИЯ ПРОФИЛЕЙ (мотивация × сегмент) ──────────────────────────────────

export const PROFILE_DESCRIPTIONS: Record<string, Record<string, string>> = {
  meaning: {
    creative: "Ты творишь не ради денег и не ради славы — ты создаёшь потому что иначе не можешь. Смысл для тебя важнее признания. Ты вкладываешь в работу часть себя и хочешь, чтобы она меняла людей к лучшему. Рутина без идеи тебя убивает.",
    help_people: "Ты рождён помогать — и в этом твоя настоящая сила. Чужая проблема для тебя не обуза, а вызов. Ты получаешь энергию от того, что кто-то после разговора с тобой идёт вперёд увереннее. Пустая работа «для галочки» тебя опустошает.",
    analytics: "Ты анализируешь не просто потому что умеешь — ты ищешь в данных правду, которая поможет людям. Системное мышление у тебя на службе у ценностей. Тебе важно, чтобы результат твоей работы имел реальное значение, а не просто красиво выглядел в отчёте.",
    business: "Ты строишь бизнес не ради прибыли как таковой — за каждым твоим проектом стоит идея, которая должна изменить что-то в мире. Деньги для тебя — инструмент, а не цель. Ты не сможешь долго работать над тем, во что не веришь.",
    education: "Передавать знания — это твоё призвание. Ты видишь потенциал в людях раньше, чем они сами его замечают. Настоящим учителем тебя делает не методология, а искренний интерес к росту других. Равнодушная аудитория выбивает тебя из колеи.",
    communication: "Ты говоришь не чтобы говорить — ты говоришь чтобы что-то изменить. Каждое выступление, каждый текст или разговор для тебя — возможность донести важную идею. Пустое общение ради нетворкинга тебя утомляет.",
    management: "Ты организуешь людей не ради власти, а ради результата, в который веришь. Твоя команда это чувствует и идёт за тобой. Ты не терпишь работы ради работы — тебе нужна цель, которая имеет смысл.",
    practical: "Ты делаешь — и в этом весь ты. Каждый созданный предмет, каждый завершённый проект несёт часть твоей души. Работа без смысла тебя не устраивает: тебе важно знать, что то, что ты сделал, реально кому-то нужно.",
    research: "Ты исследуешь не из любопытства — ты ищешь знание, которое изменит ситуацию. Поверхностные ответы тебя не устраивают. Ты готов копать до сути, если понимаешь, что результат принесёт пользу.",
    freedom: "Ты создаёшь смысл в условиях полной свободы. Никакой начальник не скажет тебе, что важно — ты это знаешь сам. Независимость для тебя не каприз, а условие, при котором ты вообще можешь работать полноценно.",
  },
  money: {
    creative: "Ты умеешь монетизировать творчество — и это редкий дар. Ты не тратишь время на проекты, которые не конвертируются. Твой творческий продукт всегда имеет цену, и ты умеешь её обосновать. Работа «за опыт» — не твоя история.",
    help_people: "Ты помогаешь людям и при этом чётко понимаешь ценность своего времени. Ты не работаешь бесплатно — не потому что жадный, а потому что понимаешь: помощь должна стоить достойно. Деньги дают тебе возможность помогать лучше и большему числу людей.",
    analytics: "Числа — твой язык, и ты умеешь на нём зарабатывать. Ты видишь финансовые возможности там, где другие видят только данные. Аналитика для тебя — инструмент роста дохода, а не просто профессиональная обязанность.",
    business: "Ты предприниматель в душе. Деньги для тебя — это счёт на табло: они показывают, насколько хорошо работает то, что ты строишь. Ты мыслишь масштабом, ищешь точки роста и умеешь превращать идеи в прибыль.",
    education: "Ты знаешь, что знание стоит денег — и умеешь это монетизировать. Онлайн-курсы, консультации, программы — ты понимаешь, как упаковать экспертизу в продукт. Работать педагогом за копейки — не твой путь.",
    communication: "Ты умеешь продавать словом. Переговоры, презентации, продающие тексты — всё это твои инструменты заработка. Ты знаешь цену своему влиянию и не стесняешься её называть.",
    management: "Ты управляешь так, чтобы это отражалось на цифрах. KPI, рост выручки, оптимизация затрат — ты говоришь на языке бизнеса. Высокая должность и высокий доход для тебя логично связаны.",
    practical: "Ты мастер, который умеет продавать своё мастерство. Качество твоей работы стоит хороших денег — и ты это знаешь. Ты не занижаешь цену и не работаешь с теми, кто не ценит профессионализм.",
    research: "Ты превращаешь знания в активы. Исследования, патенты, экспертные статьи, консультации — ты умеешь монетизировать интеллект. Работать за спасибо — это не твоё.",
    freedom: "Деньги для тебя — это свобода. Чем больше зарабатываешь, тем независимее становишься. Ты выбираешь проекты с высоким доходом, чтобы работать меньше, но на своих условиях.",
  },
  recognition: {
    creative: "Ты хочешь, чтобы твоё творчество видели. Не из тщеславия — просто ты знаешь, что твои работы достойны аудитории. Лайки, отзывы, упоминания заряжают тебя не меньше, чем сам процесс создания.",
    help_people: "Ты хочешь быть экспертом, к которому приходят. Признание в своей сфере для тебя — это не самоцель, а подтверждение того, что ты действительно помогаешь. Репутация для тебя — главный актив.",
    analytics: "Ты хочешь быть тем аналитиком, на чьё мнение ссылаются. Экспертный статус в профессиональном сообществе, публикации, выступления на конференциях — ты стремишься к тому, чтобы тебя знали как авторитет в своей области.",
    business: "Ты строишь бизнес с именем. Тебе важно, чтобы твой бренд узнавали. Публичность, медиа, нетворкинг — это не побочный эффект твоего успеха, а часть стратегии.",
    education: "Ты хочешь быть тем, у кого учатся. Известный педагог, автор курса с тысячами студентов, публичный спикер — это твои ориентиры. Признание учеников и коллег для тебя важнее любой должности.",
    communication: "Ты рождён для публичности. Аудитория, медиа, сцена — твоя среда. Тебе нужно, чтобы тебя слышали и знали. Работа в тени — не для тебя.",
    management: "Ты хочешь быть лидером, которого уважают. Не просто руководить — а вдохновлять. Твоё имя должно что-то значить в отрасли. Статус для тебя — это не корочки, а реальное влияние.",
    practical: "Ты хочешь, чтобы твоё мастерство знали. Мастер с именем, бренд, который говорит сам за себя. Отзывы клиентов, упоминания в прессе, портфолио с громкими проектами — это твой путь.",
    research: "Ты хочешь быть учёным, на которого ссылаются. Публикации, цитирование, признание в академическом или экспертном сообществе — это то, что тебя движет. Твои исследования должны знать.",
    freedom: "Ты хочешь быть известным на своих условиях. Блог, соцсети, личный бренд — ты строишь аудиторию самостоятельно, без корпоративного фасада. Свобода и признание — это одно и то же для тебя.",
  },
  freedom: {
    creative: "Ты не можешь творить по расписанию и чужим правилам. Вдохновение приходит когда хочет — и ты выстроил жизнь так, чтобы быть к нему готовым. Фриланс, удалёнка, своя студия — твои естественные форматы.",
    help_people: "Ты помогаешь людям — но только тогда, когда сам полон энергии. Жёсткий график и обязательное присутствие в офисе тебя опустошают быстрее, чем любая сложная задача. Свобода — условие твоей эффективности.",
    analytics: "Ты думаешь лучше всего в своём темпе и своём пространстве. Аналитика на удалёнке, гибкий график, возможность уйти в задачу на несколько часов без совещаний — вот когда ты выдаёшь лучшее.",
    business: "Ты строишь не просто бизнес — ты строишь свободу. Собственное дело, пассивный доход, локация без привязки — всё это не мечты, а конкретный план. Работа на кого-то для тебя — временная мера.",
    education: "Ты учишь в своём формате. Онлайн-курс, авторская программа, наставничество без жёстких рамок — ты не терпишь бюрократии в образовании. Свобода методологии для тебя важнее институционального признания.",
    communication: "Ты общаешься на своих условиях. Свой подкаст, телеграм-канал, выступления которые ты выбираешь сам — вот твоя коммуникационная платформа. Ты не будешь говорить то, что от тебя ожидают.",
    management: "Ты организуешь без бюрократии. Ты умеешь выстраивать процессы и управлять людьми, но только если у тебя есть реальные полномочия и гибкость. Управление ради управления — не твоя история.",
    practical: "Ты мастер на вольных хлебах. Свои клиенты, свой прайс, своё расписание. Ты не будешь работать в найме, если можешь работать на себя. Качество твоей работы говорит само за себя.",
    research: "Ты исследуешь то, что интересно тебе — а не то, что заказали. Независимые проекты, собственные гипотезы, возможность уйти в тему на несколько недель — твои рабочие условия.",
    freedom: "Ты — абсолютный автономист. Никаких рамок, никаких начальников, никаких жёстких графиков. Ты выстраиваешь жизнь полностью под себя — и именно в таких условиях достигаешь максимума.",
  },
  process: {
    creative: "Ты влюблён в процесс создания — и это видно в каждой работе. Для тебя важна не только точка назначения, но и путь. Ты готов часами совершенствовать деталь, которую никто кроме тебя не заметит — просто потому что так правильно.",
    help_people: "Ты по-настоящему предан своему делу. Для тебя каждая встреча, каждый разговор — это маленький проект, в который ты вкладываешься полностью. Результат важен, но не менее важен качественный процесс помощи.",
    analytics: "Ты любишь данные — не как инструмент, а почти как искусство. Красивая модель, чистая логика, элегантный анализ — это доставляет тебе настоящее удовольствие. Ты из тех, кто может потерять счёт времени за интересной задачей.",
    business: "Ты азартен в построении бизнеса. Сам процесс — переговоры, запуски, эксперименты — тебя заряжает не меньше, чем результат. Ты не умеешь скучать на рабочем месте — ты всегда что-то строишь или проверяешь.",
    education: "Ты увлечённый педагог — тебе искренне интересно объяснять, находить новые метафоры, видеть момент понимания на лице ученика. Преподавание для тебя — это не работа, это призвание.",
    communication: "Ты получаешь удовольствие от самого общения. Живой диалог, поиск точных слов, момент когда тебя понимают — это твоё топливо. Ты не выгораешь от коммуникации — ты от неё заряжаешься.",
    management: "Ты строишь процессы с любовью. Когда система работает как часы — ты чувствуешь что-то близкое к художественному удовлетворению. Ты не просто управляешь — ты конструируешь.",
    practical: "Ты ремесленник в лучшем смысле этого слова. Работа руками — это медитация. Ты совершенствуешь мастерство ради самого мастерства, и это делает тебя лучшим в своей области.",
    research: "Ты учёный-энтузиаст. Погружение в тему — это не работа, это образ жизни. Ты задаёшь вопросы, потому что не можешь иначе. И именно это делает твои исследования по-настоящему глубокими.",
    freedom: "Ты живёшь полной жизнью — без спешки, без чужих дедлайнов. Ты получаешь удовольствие от пути, а не только от цели. Свобода позволяет тебе оставаться в потоке и делать работу с кайфом.",
  },
  status: {
    creative: "Ты хочешь быть элитой в своей сфере. Не просто хорошим специалистом — а именем. Ты работаешь с топ-клиентами, берёшь дорогие заказы и строишь репутацию, которая открывает двери.",
    help_people: "Ты эксперт, к которому обращаются за особым случаем. Не рядовая консультация, а работа с теми, кому нужна настоящая экспертиза. Твой статус специалиста — это результат многолетней практики и репутации.",
    analytics: "Ты метишь в топ аналитиков своей отрасли. Тебя знают, на тебя ссылаются, у тебя учатся. Карьерный рост и профессиональный авторитет для тебя — конкретные измеримые цели.",
    business: "Ты строишь бизнес класса А. Тебе важен не просто доход — важны масштаб, влияние, место на рынке. Ты хочешь быть в числе тех, кого знает индустрия.",
    education: "Ты стремишься к авторитету профессора — в хорошем смысле. Твоё слово в профессиональном сообществе должно что-то весить. Ты строишь экспертный статус годами и относишься к этому серьёзно.",
    communication: "Ты хочешь быть голосом, которому доверяют. Влиятельный спикер, авторитетный эксперт, человек с весомым словом в отрасли — это твои ориентиры. Статус достигается через видимость и репутацию.",
    management: "Ты идёшь наверх — и это не амбиции ради амбиций. Ты понимаешь, что влияние даёт возможности. Топ-менеджер, директор, партнёр — конкретные ступени, к которым ты движешься осознанно.",
    practical: "Ты мастер высшего класса. Тебя рекомендуют только лучшим клиентам. Твоё имя — знак качества. Ты не демпингуешь и не работаешь с теми, кто не понимает ценности твоего уровня.",
    research: "Ты ведущий исследователь своей области. Публикации в серьёзных изданиях, участие в топовых конференциях, экспертный статус — это не случайность, а результат твоей стратегии.",
    freedom: "Ты успешный независимый эксперт. Статус для тебя — это не корпоративная должность, а репутация в профессиональном сообществе. Ты независим, востребован и работаешь с теми, кого сам выбираешь.",
  },
};
