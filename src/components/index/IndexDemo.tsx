...
const resultProfiles = [
  { emoji: "🎨", label: "Творческой и созидательной деятельности", desc: "Тебе подходят профессии, где можно создавать, придумывать и воплощать идеи" },
  { emoji: "🔬", label: "Аналитической и исследовательской деятельности", desc: "Тебе подходят профессии, связанные с анализом, исследованиями и глубоким погружением в задачи" },
  { emoji: "🤝", label: "Социальной и коммуникативной деятельности", desc: "Тебе подходят профессии, где нужно общаться, помогать людям и работать в команде" },
  { emoji: "⚙️", label: "Системной и организаторской деятельности", desc: "Тебе подходят профессии, где важны порядок, структура и управление процессами" },
];
        ...
        <div className="bg-white rounded-3xl border border-border shadow-sm p-5 sm:p-8">
          {step < demoQuestions.length ? (
            ...
            <div className="text-center animate-scale-in">
              ...
              <div className="gradient-brand text-white font-bold text-lg rounded-2xl px-6 py-3 inline-block mb-3">
                {r.emoji} {r.label}
              </div>
              <p className="text-muted-foreground text-sm mb-2">{r.desc}</p>
              <p className="text-muted-foreground text-xs mb-8">Полный тест из 40+ вопросов даст точный профиль и конкретные рекомендации</p>
              </>); })()}
